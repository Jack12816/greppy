...
MongoDB.prototype.migrate = function(callback)
{
    ...
    this.configure.call(this, function(err, db, orm) {
        ...
        async.each(Object.keys(orm.instance.collections), function(collection, callback) {

            collection = orm.instance.collections[collection];
            logger.info('Create ' + collection.name.yellow + ' collection\n');
            db.createCollection(collection.name, collection.opts, callback);
            ...
            if (0 === migrations.migrations.length) {
